  ...
  - [ ] [Category:Metrication by country](https://en.wikipedia.org/wiki/Category:Metrication_by_country)
    ...
    - [ ] [Category:Metrication in France](https://en.wikipedia.org/wiki/Category:Metrication_in_France)
      ...
      - [ ] [Category:French Republican calendar](https://en.wikipedia.org/wiki/Category:French_Republican_calendar)
        ...
        - [ ] [Prairial](https://en.wikipedia.org/wiki/Prairial)
...
- [ ] [Category:Conversion of units of measurement](https://en.wikipedia.org/wiki/Category:Conversion_of_units_of_measurement)
  ...
  - [ ] [Category:Metrication](https://en.wikipedia.org/wiki/Category:Metrication)
    ...
    - [ ] [Category:Metric prefixes](https://en.wikipedia.org/wiki/Category:Metric_prefixes)
      ...
      - [ ] [Hebdomo-](https://en.wikipedia.org/wiki/Hebdo-)
...
- [ ] [Category:Units of information](https://en.wikipedia.org/wiki/Category:Units_of_information)
  ...
  - [ ] [Category:Binary prefixes](https://en.wikipedia.org/wiki/Category:Binary_prefixes)
    - [ ] [Category:IEC prefixes](https://en.wikipedia.org/wiki/Category:IEC_prefixes)
      ...
      - [ ] [Yi (prefix symbol)](https://en.wikipedia.org/wiki/Binary_prefix)
      - [ ] [Yobi-](https://en.wikipedia.org/wiki/Binary_prefix)
      - [ ] [Zebi-](https://en.wikipedia.org/wiki/Binary_prefix)
      - [ ] [Zi (prefix symbol)](https://en.wikipedia.org/wiki/Binary_prefix)
  - [ ] [Category:Data unit](https://en.wikipedia.org/wiki/Category:Data_unit)
    - [ ] [1-bit computing](https://en.wikipedia.org/wiki/1-bit_computing)
    - [ ] [4-bit computing](https://en.wikipedia.org/wiki/4-bit_computing)
    - [ ] [8-bit computing](https://en.wikipedia.org/wiki/8-bit_computing)
    - [ ] [16-bit computing](https://en.wikipedia.org/wiki/16-bit_computing)
    - [ ] [24-bit computing](https://en.wikipedia.org/wiki/24-bit_computing)
    - [ ] [31-bit computing](https://en.wikipedia.org/wiki/31-bit_computing)
    - [ ] [32-bit computing](https://en.wikipedia.org/wiki/32-bit_computing)
    - [ ] [36-bit computing](https://en.wikipedia.org/wiki/36-bit_computing)
    - [ ] [45-bit computing](https://en.wikipedia.org/wiki/45-bit_computing)
    - [ ] [48-bit computing](https://en.wikipedia.org/wiki/48-bit_computing)
    - [ ] [60-bit computing](https://en.wikipedia.org/wiki/60-bit_computing)
    - [ ] [64-bit computing](https://en.wikipedia.org/wiki/64-bit_computing)
    - [ ] [128-bit computing](https://en.wikipedia.org/wiki/128-bit_computing)
    - [ ] [256-bit computing](https://en.wikipedia.org/wiki/256-bit_computing)
    - [ ] [512-bit computing](https://en.wikipedia.org/wiki/512-bit_computing)
    - [ ] [Chunk (information)](https://en.wikipedia.org/wiki/Chunk_(information))
    - [ ] [Transaction Protocol Data Unit](https://en.wikipedia.org/wiki/Transaction_Protocol_Data_Unit)
- [ ] [Category:Units of length](https://en.wikipedia.org/wiki/Category:Units_of_length)
  ...
  - [ ] [Angstrom](https://en.wikipedia.org/wiki/Angstrom)
  - [ ] [Barleycorn (unit)](https://en.wikipedia.org/wiki/Barleycorn_(unit))
  ...
  - [ ] [Siriometer](https://en.wikipedia.org/wiki/Siriometer)
  ...
  - [ ] [Category:Metre](https://en.wikipedia.org/wiki/Category:Metre)
    - [ ] [Metre](https://en.wikipedia.org/wiki/Metre)
    - [ ] [Femtometre](https://en.wikipedia.org/wiki/Femtometre)
    - [ ] [History of the metre](https://en.wikipedia.org/wiki/History_of_the_metre)
    - [ ] [Nanometre](https://en.wikipedia.org/wiki/Nanometre)
- [ ] [Category:Units of luminance](https://en.wikipedia.org/wiki/Category:Units_of_luminance)
  - [ ] [Apostilb](https://en.wikipedia.org/wiki/Apostilb)
  - [ ] [Blondel (unit)](https://en.wikipedia.org/wiki/Apostilb)
  - [ ] [Bril (unit)](https://en.wikipedia.org/wiki/Bril_(unit))
  - [ ] [Candela per square metre](https://en.wikipedia.org/wiki/Candela_per_square_metre)
  - [ ] [Lambert (unit)](https://en.wikipedia.org/wiki/Lambert_(unit))
  - [ ] [Millilambert](https://en.wikipedia.org/wiki/Lambert_(unit))
  - [ ] [Millinit](https://en.wikipedia.org/wiki/Candela_per_square_metre)
  - [ ] [Nit (unit)](https://en.wikipedia.org/wiki/Candela_per_square_metre)
  - [ ] [Skot (unit)](https://en.wikipedia.org/wiki/Skot_(unit))
  - [ ] [Stilb (unit)](https://en.wikipedia.org/wiki/Stilb_(unit))
...
- [ ] [Category:Units of mass](https://en.wikipedia.org/wiki/Category:Units_of_mass)
  - [ ] [Alternative approaches to redefining the kilogram](https://en.wikipedia.org/wiki/Alternative_approaches_to_redefining_the_kilogram)
  ...
  - [ ] [Grave (unit)](https://en.wikipedia.org/wiki/Grave_(unit))
  ...
  - [ ] [Myriagram](https://en.wikipedia.org/wiki/Myriagram)
  ...
  - [ ] [Category:Shekel](https://en.wikipedia.org/wiki/Category:Shekel)
    - [ ] [1983 Israel bank stock crisis](https://en.wikipedia.org/wiki/1983_Israel_bank_stock_crisis)
    - [ ] [Belshazzar's feast](https://en.wikipedia.org/wiki/Belshazzar%27s_feast)
    - [ ] [2 Chronicles 1](https://en.wikipedia.org/wiki/2_Chronicles_1)
    - [ ] [2 Chronicles 3](https://en.wikipedia.org/wiki/2_Chronicles_3)
    - [ ] [Coin in the fish's mouth](https://en.wikipedia.org/wiki/Coin_in_the_fish%27s_mouth)
    - [ ] [Ezekiel 4](https://en.wikipedia.org/wiki/Ezekiel_4)
    - [ ] [Hosea 3](https://en.wikipedia.org/wiki/Hosea_3)
    - [ ] [Israeli new shekel](https://en.wikipedia.org/wiki/Israeli_new_shekel)
    - [ ] [2 Kings 7](https://en.wikipedia.org/wiki/2_Kings_7)
    - [ ] [Matthew 17](https://en.wikipedia.org/wiki/Matthew_17)
    - [ ] [Old Israeli shekel](https://en.wikipedia.org/wiki/Old_Israeli_shekel)
    - [ ] [Pidyon haben](https://en.wikipedia.org/wiki/Pidyon_haben)
    - [ ] [Shekel sign](https://en.wikipedia.org/wiki/Shekel_sign)
    - [ ] [Thirty pieces of silver](https://en.wikipedia.org/wiki/Thirty_pieces_of_silver)
    - [ ] [Tyrian shekel](https://en.wikipedia.org/wiki/Tyrian_shekel)
    - [ ] [Category:Shekel banknotes](https://en.wikipedia.org/wiki/Category:Shekel_banknotes)
      - [ ] [20 new shekel banknote](https://en.wikipedia.org/wiki/20_new_shekel_banknote)
      - [ ] [50 new shekel banknote](https://en.wikipedia.org/wiki/50_new_shekel_banknote)
      - [ ] [100 new shekel banknote](https://en.wikipedia.org/wiki/100_new_shekel_banknote)
      - [ ] [200 new shekel banknote](https://en.wikipedia.org/wiki/200_new_shekel_banknote)
...
- [ ] [Category:Units of power](https://en.wikipedia.org/wiki/Category:Units_of_power)
  ...
  - [ ] [Tax horsepower](https://en.wikipedia.org/wiki/Tax_horsepower)
...
- [ ] [Category:Units of pressure](https://en.wikipedia.org/wiki/Category:Units_of_pressure)
  - [ ] [Bar (unit)](https://en.wikipedia.org/wiki/Bar_(unit))
  - [ ] [Barye](https://en.wikipedia.org/wiki/Barye)
  ...
  - [ ] [Meter of water](https://en.wikipedia.org/wiki/Centimetre_or_millimetre_of_water)
  - [ ] [Metre of water](https://en.wikipedia.org/wiki/Centimetre_or_millimetre_of_water)
  - [ ] [Metre sea water](https://en.wikipedia.org/wiki/Metre_sea_water)
  - [ ] [Millimetre of mercury](https://en.wikipedia.org/wiki/Millimetre_of_mercury)
  - [ ] [P50 (pressure)](https://en.wikipedia.org/wiki/P50_(pressure))
  - [ ] [Pascal (unit)](https://en.wikipedia.org/wiki/Pascal_(unit))
  - [ ] [Standard atmosphere (unit)](https://en.wikipedia.org/wiki/Standard_atmosphere_(unit))
  - [ ] [Suction](https://en.wikipedia.org/wiki/Suction)
...
- [ ] [Category:Units of quality](https://en.wikipedia.org/wiki/Category:Units_of_quality)
  - [ ] [Martindale (unit)](https://en.wikipedia.org/wiki/Martindale_(unit))
  - [ ] [Quality of results](https://en.wikipedia.org/wiki/Quality_of_results)
- [ ] [Category:Units of radiation dose](https://en.wikipedia.org/wiki/Category:Units_of_radiation_dose)
  ...
  - [ ] [Gray (unit)](https://en.wikipedia.org/wiki/Gray_(unit))
  ...
  - [ ] [Roentgen (unit)](https://en.wikipedia.org/wiki/Roentgen_(unit))
  - [ ] [Sievert](https://en.wikipedia.org/wiki/Sievert)
  - [ ] [Rolf Maximilian Sievert](https://en.wikipedia.org/wiki/Rolf_Maximilian_Sievert)
  - [ ] [Strontium unit](https://en.wikipedia.org/wiki/Strontium_unit)
...
- [ ] [Category:Units of radioactivity](https://en.wikipedia.org/wiki/Category:Units_of_radioactivity)
  ...
  - [ ] [Curie (unit)](https://en.wikipedia.org/wiki/Curie_(unit))
  - [ ] [Rutherford (unit)](https://en.wikipedia.org/wiki/Rutherford_(unit))
  - [ ] [Specific activity](https://en.wikipedia.org/wiki/Specific_activity)
...
- [ ] [Category:Units of temperature](https://en.wikipedia.org/wiki/Category:Units_of_temperature)
  - [ ] [Degree (temperature)](https://en.wikipedia.org/wiki/Degree_(temperature))
  - [ ] [Degree Celsius](https://en.wikipedia.org/wiki/Celsius)
  - [ ] [Degree Delisle](https://en.wikipedia.org/wiki/Delisle_scale)
  - [ ] [Degree Fahrenheit](https://en.wikipedia.org/wiki/Fahrenheit)
  - [ ] [Degree Newton](https://en.wikipedia.org/wiki/Newton_scale)
  - [ ] [Degree Rankine](https://en.wikipedia.org/wiki/Rankine_scale)
  - [ ] [Degree Réaumur](https://en.wikipedia.org/wiki/R%C3%A9aumur_scale)
  - [ ] [Degree Rømer](https://en.wikipedia.org/wiki/R%C3%B8mer_scale)
  - [ ] [Degree Wedgwood](https://en.wikipedia.org/wiki/Wedgwood_scale)
  - [ ] [Kelvin (unit)](https://en.wikipedia.org/wiki/Kelvin)
  - [ ] [Reciprocal joules](https://en.wikipedia.org/wiki/Thermodynamic_beta)
- [ ] [Category:Units of torque](https://en.wikipedia.org/wiki/Category:Units_of_torque)
  - [ ] [Dynemetre](https://en.wikipedia.org/wiki/Dynemetre)
  - [ ] [Newton-metre](https://en.wikipedia.org/wiki/Newton-metre)
- [ ] [Category:Units of velocity](https://en.wikipedia.org/wiki/Category:Units_of_velocity)
  - [ ] [Bubnoff unit](https://en.wikipedia.org/wiki/Bubnoff_unit)
...
- [ ] [Category:Units of volume](https://en.wikipedia.org/wiki/Category:Units_of_volume)
  ...
  - [ ] [Stere](https://en.wikipedia.org/wiki/Stere)
